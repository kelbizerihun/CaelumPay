...
const CirclesIcon = ({ isActive }: { isActive: boolean }) => (
    <svg className={`h-6 w-6 ${isActive ? 'text-caelum-blue' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
